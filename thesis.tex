...
\begin{document}
	...
	\todo[inline]{Q: I also looked into Random Effects but it returns the same results. I Googled and could not find an explanation. I think it may be because there is little regional heterogenous variation, i.e. $\sigma^2_alpha = 0$. Is this correct? If so, do you know of a source that I can cite or is this unnecessary and can I just write it down myself?}
