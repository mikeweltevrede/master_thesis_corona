...
# Google recently released the actual data where they previously only reported
# graphs and the percentages at the end of the period and this data was used
# instead.

# Before, we interpolated from the Google Mobility Report (by eye and hand).
